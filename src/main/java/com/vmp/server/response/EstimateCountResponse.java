...
//    private Double cpt_comm;
    ...
    public EstimateCountResponse(/*Integer ao_count_comm, Double price_comm, Integer traffic_comm, Integer ots_comm, Integer coverage_comm, Double cpt_comm, */Double placement_fin, Double b1_price, Double price_fin, Double price_vat_fin, ArrayList<EstimateResponse> estimateResponses) {
