...
public class CPResponse {
    ...
    public CPResponse(String name, String client, String brand, Date date_from, Date date_to, Date creating_date, String placing_format, ArrayList<Integer> advObjectsId, ArrayList<EstimateResponse> estimateList, Integer ao_count_comm, Double b1_price, Integer coverage_comm, Double cpt_comm, Integer ots_comm, Double placement_fin, Double price_comm, Double price_fin, Double price_vat_fin, Integer traffic_comm) {
        this.name = name;
        this.client = client;
        this.brand = brand;
